...
Write a function named sortPeople that takes in an array of Person objects, each of which has fiarstName, lstName, and age properties, and sorts those people by their last names. Do not worry about capitalization or first names.
------------------------------------------------------------------------------------------------ */
...
const sortMeetingsByDay = (arr) => {
  ...
  return arr.sort((a, b) => (dayValue[a.dayOfWeek] - dayValue[b.dayOfWeek]));
};
...
Sort the meetings in the order that they start. I meeting shf two meetings start at the same time on the same day, the shorterould come first.
...
const sortSchedule = (arr) => {
  ...
  return arr.sort((a, b) => {
    if (a.dayOfWeek === b.dayOfWeek) {
      if (a.start === b.start) {
        return (parseInt(b.start) - parseInt(b.end)) -(parseInt(a.start) - parseInt(a.end));
      }else {
